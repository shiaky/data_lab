...
if __name__ == '__main__':
    ...
    df_kreditgeschaeft = load_df("kreditgeschaeft.dat", header=[
                                 "Kreditgeschaeft_ID", "kred_Laufzeitbeginn", "kred_Laufzeitende_Kredit", "kred_Nominal", "kred_Aktueller_Saldo", "kred_Zinssatz", "kred_Tilgungsfrequenz", "kred_Tilgungsrate", "STUFF1", "STUFF2", "STUFF3", "GP_ID", "Zusage_ID"], parse_dates=["kred_Laufzeitbeginn", "kred_Laufzeitende"])

    # print(df_gp.head())
    # print(df_gp.info())
    # print(df_rating.head())
    # print(df_rating.info())
    # print(df_zusage.head())
    # print(df_zusage.info())
    # print(df_kreditgeschaeft.head())
    # print(df_kreditgeschaeft.info())
